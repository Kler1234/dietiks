...
.p-toggleable-content-leave-from {
  ...
  * {
  ...
  .p-autocomplete.p-invalid.p-component > .p-text {
    border-color: #f87171;
  }
...
.p-calendar .p-datepicker-touch-ui {
  ...
  .p-calendar.p-invalid.p-component > .p-text {
    border-color: #f87171;
  }
  .p-calendar:not(.p-calendar-disabled).p-focus > .p-text {
    outline: 1px solid var(--p-focus-ring-color);
    outline-offset: -1px;
    box-shadow: none;
    border-color: #94a3b8;
...
.p-cascadeselect-leave-active {
  ...
  .p-checkbox:not(.p-disabled):has(.p-checkbox-:hover) .p-checkbox-box {
    border-color: #94a3b8;
  }
  .p-checkbox:not(.p-disabled):has(.p-checkbox-:hover).p-highlight .p-checkbox-box {
    border-color: #059669;
    background: #059669;
    color: #ffffff;
  }
  .p-checkbox:not(.p-disabled):has(.p-checkbox-:focus-visible) .p-checkbox-box {
    outline: 1px solid var(--p-focus-ring-color);
    outline-offset: -1px;
    box-shadow: none;
    border-color: #94a3b8;
  ...
  .p-checkbox.p-variant-filled:not(.p-disabled):has(.p-checkbox-:hover) .p-checkbox-box {
    background-color: #f8fafc;
  }
  .p-checkbox.p-variant-filled:not(.p-disabled):has(.p-checkbox-:hover).p-highlight .p-checkbox-box {
    background: #059669;
  }

  .p--filled .p-checkbox .p-checkbox-box {
    background-color: #f8fafc;
  }
  .p--filled .p-checkbox.p-highlight .p-checkbox-box {
    background: #10b981;
  }
  .p--filled .p-checkbox:not(.p-disabled):has(.p-checkbox-:hover) .p-checkbox-box {
    background-color: #f8fafc;
  }
  .p--filled .p-checkbox:not(.p-disabled):has(.p-checkbox-:hover).p-highlight .p-checkbox-box {
    background: #059669;
  }
  ...
  .p-chips.p-invalid.p-component > .p-text {
    border-color: #f87171;
  }
...
.p-colorpicker-panel .p-colorpicker-hue-handle {
  ...
  .p-dropdown.p-variant-filled:not(.p-disabled).p-focus .p-text {
    background-color: transparent;
  }
  ...
  .p-float-label:has(:focus) label,
.p-float-label:has(.p-filled) label,
.p-float-label:has(:-webkit-autofill) label,
.p-float-label:has(textarea:focus) label,
.p-float-label:has(textarea.p-filled) label,
.p-float-label:has(.p-wrapper-focus) label,
.p-float-label:has(.p-wrapper-filled) label {
    top: -0.75rem;
    font-size: 12px;
  }
...
.p-float-label .p-text::placeholder {
    opacity: 0;
    transition-property: all;
    transition-timing-function: ease;
  }
...
.p-float-label :focus::placeholder,
.p-float-label .p-text:focus::placeholder {
    opacity: 1;
    transition-property: all;
    transition-timing-function: ease;
  }
...
.p-fluid .p-group .p- {
  ...
  .p-group-addon:last-child {
    border-right: 1px solid #cbd5e1;
  }

  .p-group > .p-component,
.p-group > .p-wrapper > .p-text,
.p-group > .p-float-label > .p-component {
    border-radius: 0;
    margin: 0;
  }
  .p-group > .p-component + .p-group-addon,
.p-group > .p-wrapper > .p-text + .p-group-addon,
.p-group > .p-float-label > .p-component + .p-group-addon {
    border-left: 0 none;
  }
  .p-group > .p-component:focus,
.p-group > .p-wrapper > .p-text:focus,
.p-group > .p-float-label > .p-component:focus {
    z-index: 1;
  }
  .p-group > .p-component:focus ~ label,
.p-group > .p-wrapper > .p-text:focus ~ label,
.p-group > .p-float-label > .p-component:focus ~ label {
    z-index: 1;
  }

  .p-group-addon:first-child,
.p-group button:first-child,
.p-group :first-child,
.p-group > .p-wrapper:first-child,
.p-group > .p-wrapper:first-child > .p-text {
    border-top-left-radius: 6px;
    border-bottom-left-radius: 6px;
  }

  .p-group .p-float-label:first-child  {
    border-top-left-radius: 6px;
    border-bottom-left-radius: 6px;
  }

  .p-group-addon:last-child,
.p-group button:last-child,
.p-group :last-child,
.p-group > .p-wrapper:last-child,
.p-group > .p-wrapper:last-child > .p-text {
    border-top-right-radius: 6px;
    border-bottom-right-radius: 6px;
  }

  .p-group .p-float-label:last-child  {
    border-top-right-radius: 6px;
    border-bottom-right-radius: 6px;
  }

  .p-fluid .p-group .p-button {
    width: auto;
  }
  .p-fluid .p-group .p-button.p-button-icon-only {
    width: 2.5rem;
  }
...
.p-fluid .p-icon-field-right {
  ...
  .p-icon-field-left > .p--icon:first-of-type {
    left: 0.75rem;
    color: #94a3b8;
  }

  .p-icon-field-right > .p--icon:last-of-type {
    right: 0.75rem;
    color: #94a3b8;
  }
  ...
  .p-number-buttons-stacked .p-button.p-number-button .p-button-label,
.p-number-buttons-horizontal .p-button.p-number-button .p-button-label {
    display: none;
  }

  .p-number-buttons-stacked .p-button.p-number-button-up {
    border-top-left-radius: 0;
    border-bottom-left-radius: 0;
    border-bottom-right-radius: 0;
    padding: 0;
  ...
  .p-number-buttons-stacked .p-number- {
    border-top-right-radius: 0;
    border-bottom-right-radius: 0;
  }

  .p-number-buttons-stacked .p-button.p-number-button-down {
    border-top-left-radius: 0;
    border-top-right-radius: 0;
    border-bottom-left-radius: 0;
    padding: 0;
  ...
  .p-number-buttons-stacked .p-number-button-group {
    display: flex;
    flex-direction: column;
  }

  .p-number-buttons-stacked .p-number-button-group .p-button.p-number-button {
    flex: 1 1 auto;
  }

  .p-number-buttons-horizontal .p-button.p-number-button-up {
    order: 3;
    border-top-left-radius: 0;
    border-bottom-left-radius: 0;
  }

  .p-number-buttons-horizontal .p-number- {
    order: 2;
    border-radius: 0;
  }

  .p-number-buttons-horizontal .p-button.p-number-button-down {
    order: 1;
    border-top-right-radius: 0;
    border-bottom-right-radius: 0;
  }

  .p-number-buttons-vertical {
    flex-direction: column;
  }

  .p-number-buttons-vertical .p-button.p-number-button-up {
    order: 1;
    border-bottom-left-radius: 0;
    border-bottom-right-radius: 0;
    width: 100%;
  ...
  .p-number-buttons-vertical .p-number- {
    order: 2;
    border-radius: 0;
    text-align: center;
  }

  .p-number-buttons-vertical .p-button.p-number-button-down {
    order: 3;
    border-top-left-radius: 0;
    border-top-right-radius: 0;
    width: 100%;
  ...
  .p-fluid .p-number .p-number- {
    width: 1%;
  }

  .p-fluid .p-number-buttons-vertical .p-number- {
    width: 100%;
  }

  .p-number.p-invalid.p-component > .p-text {
    border-color: #f87171;
  }
  .p-number.p-variant-filled > .p-number- {
    background-color: #f8fafc;
  }
  .p-number.p-variant-filled > .p-number-:enabled:hover {
    background-color: #f8fafc;
  }
  .p-number.p-variant-filled > .p-number-:enabled:focus {
    background-color: #ffffff;
  }
  ...
  .p-switch .p-switch-slider:before {
    background: #ffffff;
    width: 1rem;
    height: 1rem;
    left: 0.25rem;
  ...
  .p-switch.p-highlight .p-switch-slider {
    background: #10b981;
  }
  .p-switch.p-highlight .p-switch-slider:before {
    background: #ffffff;
    transform: translateX(1rem);
  }
  .p-switch:not(.p-disabled):has(.p-switch-:hover) .p-switch-slider {
    background: #94a3b8;
  }
  .p-switch:not(.p-disabled):has(.p-switch-:hover).p-highlight .p-switch-slider {
    background: #059669;
  }
  .p-switch:not(.p-disabled):has(.p-switch-:focus-visible) .p-switch-slider {
    outline: 1px solid var(--p-focus-ring-color);
    outline-offset: 2px;
    box-shadow: none;
  }
  .p-switch.p-invalid > .p-switch-slider {
    border-color: #f87171;
  }
  ...
  .p-text:enabled:hover {
    border-color: #94a3b8;
  }
  .p-text:enabled:focus {
    outline: 1px solid var(--p-focus-ring-color);
    outline-offset: -1px;
    box-shadow: none;
    border-color: #94a3b8;
  }
  .p-text.p-invalid.p-component {
    border-color: #f87171;
  }
  .p-text.p-variant-filled {
    background-color: #f8fafc;
  }
  .p-text.p-variant-filled:enabled:hover {
    background-color: #f8fafc;
  }
  .p-text.p-variant-filled:enabled:focus {
    background-color: #ffffff;
  }
  .p-text.p-text-sm {
    font-size: 0.875rem;
  ...
  .p--filled .p-text:enabled:hover {
    background-color: #f8fafc;
  }
  .p--filled .p-text:enabled:focus {
    background-color: #ffffff;
  }
  ...
  .p-multiselect-filter-container .p-text {
    width: 100%;
  }
  ...
  .p-wrapper-filled.p-multiselect.p-multiselect-chip .p-multiselect-label {
    padding: 0.25rem 0.75rem;
  }
  ...
  .p-multiselect-panel .p-multiselect-header .p-multiselect-filter-container .p-text {
    padding-right: 1.75rem;
  }
  ...
  .p-password-::-ms-reveal,
.p-password-::-ms-clear {
    display: none;
  }

  .p-password.p-invalid.p-component > .p-text {
    border-color: #f87171;
  }
  ...
  .p-radiobutton:not(.p-disabled):has(.p-radiobutton-:hover) .p-radiobutton-box {
    border-color: #94a3b8;
  }
  .p-radiobutton:not(.p-disabled):has(.p-radiobutton-:hover).p-highlight .p-radiobutton-box {
    border-color: #059669;
    background: #ffffff;
  }
  .p-radiobutton:not(.p-disabled):has(.p-radiobutton-:hover).p-highlight .p-radiobutton-box .p-radiobutton-icon {
    background-color: #059669;
  }
  .p-radiobutton:not(.p-disabled):has(.p-radiobutton-:focus-visible) .p-radiobutton-box {
    outline: 1px solid var(--p-focus-ring-color);
    outline-offset: -1px;
    box-shadow: none;
    border-color: #94a3b8;
  ...
  .p-radiobutton.p-variant-filled:not(.p-disabled):has(.p-radiobutton-:hover) .p-radiobutton-box {
    background-color: #f8fafc;
  }
  .p-radiobutton.p-variant-filled:not(.p-disabled):has(.p-radiobutton-:hover).p-highlight .p-radiobutton-box {
    background: #ffffff;
  }

  .p--filled .p-radiobutton .p-radiobutton-box {
    background-color: #f8fafc;
  }
  .p--filled .p-radiobutton.p-highlight .p-radiobutton-box {
    background: #ffffff;
  }
  .p--filled .p-radiobutton:not(.p-disabled):has(.p-radiobutton-:hover) .p-radiobutton-box {
    background-color: #f8fafc;
  }
  .p--filled .p-radiobutton:not(.p-disabled):has(.p-radiobutton-:hover).p-highlight .p-radiobutton-box {
    background: #ffffff;
  }
...
.p-selectbutton .p-button.p-highlight:hover .p-button-icon-right {
  ...
  .p-wrapper-filled.p-treeselect.p-treeselect-chip .p-treeselect-label {
    padding: 0.25rem 0.75rem;
  }
  ...
  .p--filled .p-treeselect {
    background: #f8fafc;
  }
  .p--filled .p-treeselect:not(.p-disabled):hover {
    background-color: #f8fafc;
  }
  .p--filled .p-treeselect:not(.p-disabled).p-focus {
    background-color: #ffffff;
  }
...
.p-togglebutton.p-highlight .p-button .p-button-icon-right {
  ...
  .p-togglebutton:not(.p-disabled):has(.p-togglebutton-:hover):not(.p-highlight) .p-button {
    background: #f1f5f9;
    border-color: #f1f5f9;
    color: #334155;
  }
  .p-togglebutton:not(.p-disabled):has(.p-togglebutton-:hover):not(.p-highlight) .p-button .p-button-icon-left,
.p-togglebutton:not(.p-disabled):has(.p-togglebutton-:hover):not(.p-highlight) .p-button .p-button-icon-right {
    color: #334155;
  }
  .p-togglebutton:not(.p-disabled):has(.p-togglebutton-:hover).p-highlight .p-button {
    background: #f1f5f9;
    border-color: #f1f5f9;
    color: #0f172a;
  }
  .p-togglebutton:not(.p-disabled):has(.p-togglebutton-:hover).p-highlight .p-button .p-button-icon-left,
.p-togglebutton:not(.p-disabled):has(.p-togglebutton-:hover).p-highlight .p-button .p-button-icon-right {
    color: #0f172a;
  }
  .p-togglebutton:not(.p-disabled):has(.p-togglebutton-:focus-visible) .p-button {
    outline: 1px solid var(--p-focus-ring-color);
    outline-offset: -1px;
    box-shadow: none;
    border-color: #94a3b8;
